# page.engagement-rings — build plan (full values)
...
| 2 | `about_columns_four_LEFUDH` | `about-columns-four` | live | text_block ×10 | NO |
| 3 | `collections_list_feNKa9` | `collections-list` | live | collection_item ×10 | NO |
| 4 | `fye_mediatext_custom_eng` | `fye-media-text` | live | button | yes |
| 5 | `featured_collection_NFfNPH` | `featured-collection` | live | — | yes |
| 6 | `fye_guidedl_eng` | `fye-guide-download` | live | button | NO |
| 7 | `shipping_why_eng` | `shipping` | live | shipping ×8 | NO |
| 8 | `fye_mediatext_consult_eng` | `fye-media-text` | live | button | yes |
| 9 | `accordion_faq_eng` | `accordion` | live | accor_item ×7 | NO |
| 10 | `fye_mediatext_guarantee_eng` | `fye-media-text` | live | — | yes |
| 11 | `fye_consultation_eng` | `fye-consultation` | live | contact ×3 | yes |
| 12 | `custom_liquid_MHBtjD` | `custom-liquid` | live | — | NO |
...
- `side_padding_mb`: 16
- blocks:
  - **heading** `heading_html_Dxkwrw`
    - `html`: <h1 class="fye-hero-h1" style="font-family:'Tenor Sans',sans-serif;font-size:clamp(24px,4vw,38px);max-width:560px;line-height:1.3;font-weight:400;letter-spacing:0.02em;color:#f2f1e8;margin:0 0 15px;text-transform:none;">Engagement Rings by</h1>
  ...
  - **subtext** `subtext_custom_text_Nb3mBi`
    - `text`: Discover your perfect engagement ring, crafted with love, ethical materials, and timeless beauty to last a lifetime.
    - `tag`: p
    - `color`: #f2f1e8
    - `font_size`: 18
    - `line_height`: 29
  ...
  - **button** `button_custom_button_jJxeTx`
    - `text`: VIEW OUR Engagement Rings
    - `link`: shopify://collections/engagement-rings
    - `target`: _self
    - `bg_color`: #f2f1e8
    - `text_color`: #233d47
    ...
    - `min_height_mb`: 44
    - `padding_lr_mb`: 20
  - **button** `button_custom_button_guideEng`
    - `text`: Engagement Ring Guide
    - `link`: shopify://pages/engagement-ring-guide
    - `target`: _self
    - `bg_color`: #f2f1e8
    - `text_color`: #233d47
    - `bg_color_hover`: #233d47
    ...
    - `min_height_mb`: 44
    - `padding_lr_mb`: 20
  - **spacer** `spacer_gap_logo_eng`
    - `height`: 24
    - `height_mb`: 1

### `about-columns-four` — id `about_columns_four_LEFUDH`
...
- blocks:
  - **text_block** `text_block_74ApTG`
    - `enable_image`: true
    - `image`: shopify://shop_images/11_2ffb2c6d-eff8-43b3-b8b0-a76aea4e77b4.png
    - `title`: Solitaire Ring with diamond shoulders
    - `button_label`: VIEW OUR RINGS
    - `button_link`: shopify://collections/solitaire
    - `open_link`: _blank
    - `button_style`: default
    - `btn_size`: extra-small
    - `btn_cl`: dark
    - `button_effect`: fade
  - **text_block** `text_block_9Um8WB`
    - `enable_image`: true
    - `image`: shopify://shop_images/12.png
    - `title`: Solitaire Ring with plain shoulders
    - `button_label`: VIEW OUR RINGS
    - `button_link`: shopify://collections/solitaire
    - `open_link`: _blank
    - `button_style`: default
    ...
    - `btn_cl`: dark
    - `button_effect`: fade
  - **text_block** `text_block_hwAaxQ`
    - `enable_image`: true
    - `image`: shopify://shop_images/13.png
    - `title`: Halo Ring with diamond shoulders
    - `button_label`: VIEW OUR RINGS
    - `button_link`: shopify://collections/halo-1
    - `open_link`: _blank
    - `button_style`: default
    - `btn_size`: extra-small
    - `btn_cl`: dark
    - `button_effect`: fade
  - **text_block** `text_block_9iby6F`
    - `enable_image`: true
    - `image`: shopify://shop_images/14.png
    - `title`: Halo Ring with plain shoulders
    - `button_label`: VIEW OUR RINGS
    - `button_link`: shopify://collections/halo-1
    - `open_link`: _blank
    - `button_style`: default
    ...
    - `btn_cl`: dark
    - `button_effect`: fade
  - **text_block** `text_block_hTMd4B`
    - `enable_image`: true
    - `image`: shopify://shop_images/15.png
    - `title`: Multistone Invisible Set
    - `button_label`: VIEW OUR RINGS
    - `button_link`: shopify://collections/multistone-invisible
    - `open_link`: _blank
    - `button_style`: default
    - `btn_size`: extra-small
    - `btn_cl`: dark
    - `button_effect`: fade
  - **text_block** `text_block_LHy8Df`
    - `enable_image`: true
    - `image`: shopify://shop_images/21.png
    - `title`: Trilogy Ring
    - `button_label`: VIEW OUR RINGS
    - `button_link`: shopify://collections/trilogy
    - `open_link`: _blank
    - `button_style`: default
    - `btn_size`: extra-small
    - `btn_cl`: dark
    - `button_effect`: fade
  - **text_block** `text_block_pD6E4m`
    - `enable_image`: true
    - `image`: shopify://shop_images/22.png
    - `title`: Hidden Halo
    - `button_label`: VIEW OUR RINGS
    - `button_link`: shopify://collections/hidden-halo
    - `open_link`: _blank
    - `button_style`: default
    - `btn_size`: extra-small
    - `btn_cl`: dark
    - `button_effect`: fade
  - **text_block** `text_block_FmFPVy`
    - `enable_image`: true
    - `image`: shopify://shop_images/23.png
    - `title`: Split Shoulders
    - `button_label`: VIEW OUR RINGS
    - `button_link`: shopify://collections/split-shoulders
    - `open_link`: _blank
    - `button_style`: default
    - `btn_size`: extra-small
    - `btn_cl`: dark
    - `button_effect`: fade
  - **text_block** `text_block_pQamUQ`
    - `enable_image`: true
    - `image`: shopify://shop_images/24.png
    - `title`: Oyster Deluxe
    - `button_label`: VIEW OUR RINGS
    - `button_link`: shopify://collections/oyster-deluxe
    - `open_link`: _blank
    - `button_style`: default
    - `btn_size`: extra-small
    - `btn_cl`: dark
    - `button_effect`: fade
  - **text_block** `text_block_Tfgy3L`
    - `enable_image`: true
    - `image`: shopify://shop_images/25.png
    - `title`: Coloured Stones
    - `button_label`: VIEW OUR RINGS
    - `button_link`: shopify://collections/coloured-engagement-ring
    - `open_link`: _blank
    - `button_style`: default
    - `btn_size`: extra-small
    - `btn_cl`: dark
...
### `collections-list` — id `collections_list_feNKa9`
...
- blocks:
  ...
  - **collection_item** `collection_item_xATLPa`
...
- `body`: <p>Create a unique, bespoke ring that perfectly reflects your love story—crafted with ethical diamonds, sustainable metals, and expert craftsmanship.</p>
- blocks:
  - **button** `btn_build`
...
### `fye-guide-download` — id `fye_guidedl_eng`
...
- `body`: <p>Budget, the Four Cs, diamond shapes, settings and sizing — read online or take the free PDF before you buy.</p>
- blocks:
  - **button** `btn_download`
...
- blocks:
  ...
  - **shipping** `shipping_bVDUpk`
    - `icon_themes`: none
    - `icon`: las la-shipping-fast
    - `text`: <p>Lifetime Warranty agaist manufacturing defects</p>
...
### `fye-media-text` — id `fye_mediatext_consult_eng`
...
### `accordion` — id `accordion_faq_eng`
...
- `custom_width`: 1000
- blocks:
  - **accor_item** `accor_item_VeDG49`
    - `icon`: none
    - `title`: What makes your wedding and engagement rings ethical?
  ...
  - **accor_item** `accor_item_HAVMmt`
    - `icon`: none
    - `title`: Do you offer financing or payment plans?
    - `content`: <p>Yes, we offer flexible financing and payment plans to help make your dream ring more affordable. Our options may include:</p><ul><li>Interest-free instalments</li><li>Buy now, pay later options</li><li>Custom payment schedules for bespoke pieces</li></ul><p>Please contact us at <a href="mailto:hello@foryoureternity.com">hello@foryoureternity.com</a> for details on available financing options and eligibility requirements.</p>

### `fye-media-text` — id `fye_mediatext_guarantee_eng`
...
- `body`: <ul><li>GIA & IGI Certified Diamonds</li><li>Ethical, conflict free gemstones & precious metals</li><li>20% discount on your engagement ring for returning customers</li><li>Free insured delivery</li><li>Complimentary resizing for one year</li><li>Complimentary cleaning for life</li><li>Lifetime warranty against manufacturing defects</li></ul>

### `fye-consultation` — id `fye_consultation_eng`
...
### `custom-liquid` — id `custom_liquid_MHBtjD`

- `custom_liquid`: <script type="application/ld+json">
{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What makes your wedding and engagement rings ethical?","acceptedAnswer":{"@type":"Answer","text":"At For Your Eternity, we are committed to ethical sourcing and responsible practices. Our rings are crafted using conflict-free or lab-grown diamonds, responsibly sourced or recycled precious metals, and sustainable materials wherever possible. We adhere to the Kimberley Process Certification Scheme (KPCS) and the World Diamond Council System of Warranties (SoW) to ensure all our diamonds are ethically obtained. Additionally, we work only with trusted suppliers who meet strict environmental and human rights standards."}},{"@type":"Question","name":"Do you offer custom ring designs?","acceptedAnswer":{"@type":"Answer","text":"Yes! We offer a fully bespoke ring design service, allowing you to create a one-of-a-kind engagement or wedding ring. Our experts will guide you through the process, from selecting the perfect diamond or gemstone to designing a setting that reflects your unique style. Whether you want a modern, classic, or vintage-inspired design, we can bring your vision to life."}},{"@type":"Question","name":"How long does it take to receive a custom wedding or engagement ring?","acceptedAnswer":{"@type":"Answer","text":"Custom rings typically take 4-6 weeks from the date of design approval to completion. However, this timeframe can vary depending on the complexity of the design, material availability, and any additional customisation requests. If you need a ring by a specific date, please contact us, and we'll do our best to accommodate your timeline."}},{"@type":"Question","name":"What is your return policy?","acceptedAnswer":{"@type":"Answer","text":"We want you to love your ring, and we stand by the quality of our craftsmanship. However, due to the personalised nature of engagement and wedding rings, we can only accept returns in the following circumstances: custom, bespoke, or made-to-order rings are non-returnable and non-refundable. Ready-to-wear rings can be returned within 30 days of purchase, provided they are unworn, in original packaging, and in resalable condition. If there is a manufacturing defect or the ring does not match the agreed specifications, we will replace or repair it free of charge. To initiate a return, please email hello@foryoureternity.com with your order details."}},{"@type":"Question","name":"Are your diamonds certified?","acceptedAnswer":{"@type":"Answer","text":"Yes, all our natural and lab-grown diamonds come with independent certification from leading gemological institutes, such as the Gemological Institute of America (GIA) and International Gemological Institute (IGI). This certification guarantees the diamond's authenticity and provides a detailed analysis of its cut, colour, clarity, and carat weight."}},{"@type":"Question","name":"Do you offer matching wedding bands?","acceptedAnswer":{"@type":"Answer","text":"Absolutely! We can create perfectly matching wedding bands to complement your engagement ring. Whether you want a classic plain band, diamond-set band, or a custom-fitted design, we'll ensure your wedding band sits seamlessly alongside your engagement ring. We can also design bands to match rings purchased elsewhere - simply book a consultation to discuss your options."}},{"@type":"Question","name":"Do you offer financing or payment plans?","acceptedAnswer":{"@type":"Answer","text":"Yes, we offer flexible financing and payment plans to help make your dream ring more affordable. Our options may include interest-free instalments, buy now pay later options, and custom payment schedules for bespoke pieces. Please contact us at hello@foryoureternity.com for details on available financing options and eligibility requirements."}}]}
</script>
- `layout`: t4s-container-wrap
