# page.eternity-rings — build plan
...
| 8 | `fye-media-text` | live | — | NO |
| 9 | `fye-consultation` | live | contact ×3 | NO |
...
- blocks:
  ...
  - **subtext** — `text`: Celebrate a love with no beginning and no end — ethically crafted eternity rings, set with… · `tag`: p · `color`: #f2f1e8 · `font_size`: 18 · `line_height`: 29 · `font_weight`: 300 · `margin_bottom`: 15 · `font_size_mb`: 15 · `line_height_mb`: 22 · `margin_bottom_mb`: 10
  - **spacer** — `height`: 24 · `height_mb`: 2
  - **button** — `text`: VIEW OUR ETERNITY Rings · `link`: shopify://collections/eternity-rings · `target`: _self · `bg_color`: #f2f1e8 · `text_color`: #233d47 · `bg_color_hover`: #233d47 · `text_color_hover`: #ffffff · `font_size`: 13 · `font_weight`: 500 · `letter_spacing`: 2 · `min_height`: 48 · `padding_lr`: 34 · `uppercase`: true · `font_size_mb`: 12 · `min_height_mb`: 44 · `padding_lr_mb`: 20
  - **button** — `text`: Eternity Ring Guide · `link`: shopify://pages/eternity-ring-guide · `target`: _self · `bg_color`: #f2f1e8 · `text_color`: #233d47 · `bg_color_hover`: #233d47 · `text_color_hover`: #ffffff · `font_size`: 13 · `font_weight`: 500 · `letter_spacing`: 2 · `min_height`: 48 · `padding_lr`: 34 · `uppercase`: true · `font_size_mb`: 12 · `min_height_mb`: 44 · `padding_lr_mb`: 20
...
- `body`: <p>An eternity ring marks a milestone — an anniversary, a vow renewed, a life shared. We c…
- blocks:
...
- `body`: <p>Full and half eternity styles, stone settings, spacing and how to wear them — read onli…
- blocks:
  - **button** — `label`: View The Guide · `link`: shopify://pages/eternity-ring-guide · `style`: btn--onteal
...
- `custom_width`: 1000
- blocks:
  - **accor_item** — `icon`: none · `title`: What makes your eternity rings ethical? · `content`: <p>At For Your Eternity, we are committed to ethical sourcing and responsible practices. O…
