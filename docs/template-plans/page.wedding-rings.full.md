# page.wedding-rings — build plan (full values)
...
| 2 | `fye_mediatext_findingbands_wed` | `fye-media-text` | live | button | yes |
| 3 | `featured_collection_NFfNPH` | `featured-collection` | live | — | yes |
| 4 | `fye_guidedl_wed` | `fye-guide-download` | live | button | NO |
| 5 | `shipping_why_wed` | `shipping` | live | shipping ×8 | NO |
| 6 | `fye_mediatext_consult_wed` | `fye-media-text` | live | button | yes |
| 7 | `accordion_faq_wed` | `accordion` | live | accor_item ×7 | NO |
| 8 | `fye_mediatext_custom_wed` | `fye-media-text` | live | button | yes |
| 9 | `fye_mediatext_guarantee_wed` | `fye-media-text` | live | — | yes |
| 10 | `fye_consultation_wed` | `fye-consultation` | live | contact ×3 | yes |
...
- `side_padding_mb`: 16
- blocks:
  - **heading** `heading_html_WQGxbY`
    - `html`: <h1 class="fye-hero-h1" style="font-family:'Tenor Sans',sans-serif;font-size:clamp(24px,4vw,38px);max-width:560px;line-height:1.3;font-weight:400;letter-spacing:0.02em;color:#f2f1e8;margin:0 0 15px;text-transform:none;">Wedding Rings by</h1>
  ...
  - **subtext** `subtext_custom_text_Nb3mBi`
    - `text`: Celebrate your eternal love with ethically crafted wedding rings that embody timeless elegance and sustainable style.
    - `tag`: p
    - `color`: #f2f1e8
    - `font_size`: 18
    - `line_height`: 29
  ...
  - **button** `button_custom_button_jJxeTx`
    - `text`: VIEW OUR WEDDING Rings
    - `link`: shopify://collections/wedding-rings
    - `target`: _self
    - `bg_color`: #f2f1e8
    - `text_color`: #233d47
    ...
    - `min_height_mb`: 44
    - `padding_lr_mb`: 20
  - **button** `button_custom_button_guideWed`
    - `text`: Wedding Ring Guides
    - `link`: shopify://pages/jewellery-guides
    - `target`: _self
    - `bg_color`: #f2f1e8
    - `text_color`: #233d47
    - `bg_color_hover`: #233d47
    ...
    - `min_height_mb`: 44
    - `padding_lr_mb`: 20
  - **spacer** `spacer_gap_logo_wed`
    - `height`: 24
    - `height_mb`: 1

### `fye-media-text` — id `fye_mediatext_findingbands_wed`
...
- `body`: <p>Matching, complementary or completely different — wedding rings are usually chosen as a pair. The right profile, width and metal decide how a band feels every day.</p><ul><li>Court, D-shape or flat — profiles for every hand</li><li>Yellow, white and rose gold, or platinum for life</li><li>Matched pairs and bands shaped to fit her engagement ring</li></ul>
- blocks:
  - **button** `btn_start`
    - `label`: Wedding Rings: Where To Start
    - `link`: shopify://collections/wedding-rings
    - `style`: btn--onteal
...
### `fye-guide-download` — id `fye_guidedl_wed`
...
- `body`: <p>Plain bands and diamond-set — profiles, metals, settings and sizing. Read online or take the free PDFs.</p>
- blocks:
  - **button** `btn_download`
    - `label`: View The Guides
    - `link`: shopify://pages/jewellery-guides
    - `style`: btn--onteal

### `shipping` — id `shipping_why_wed`
...
### `fye-media-text` — id `fye_mediatext_consult_wed`
...
### `accordion` — id `accordion_faq_wed`
...
### `fye-media-text` — id `fye_mediatext_custom_wed`
...
- `body`: <p>Sometimes a traditional straight wedding band will not sit well against your engagement ring. Our solution: a wedding ring designed to exactly fit its contours and match it perfectly. Book a free consultation to design yours.</p>
- blocks:
  - **button** `btn_book`
    - `label`: Book Consultation
    - `link`: https://calendar.app.google/UKFkGvMLzAYEviqy8
...
### `fye-media-text` — id `fye_mediatext_guarantee_wed`
...
### `fye-consultation` — id `fye_consultation_wed`
